...
public class HappyHatchingCOMEngineManagerTest {
	...
	public void setUp() throws Exception {
		logger = Logger.getLogger(HappyHatchingCOMEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/HappyHatching/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/HappyHatching/InitOutcome.xml").getDocumentElement();
